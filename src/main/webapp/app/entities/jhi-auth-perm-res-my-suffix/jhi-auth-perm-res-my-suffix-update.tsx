    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="securityDesignApp.jhiAuthPermRes.home.createOrEditLabel">Create or edit a JhiAuthPermRes</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : jhiAuthPermResEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label for="jhiPermission.id">Jhi Permission</Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label for="jhiResource.id">Jhi Resource</Label>
                  <AvInput
